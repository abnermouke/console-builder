...
@section('container')
    <div class="row g-5 g-xl-8">
        @if(acb_has_permission('abnermouke.console.configs.index', 'get'))
            <div class="col-xl-3">
                <a href="{{ route('abnermouke.console.configs.index') }}" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                    <div class="card-body">
                        ...
                        <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">{{ (new \App\Repository\Abnermouke\Console\ConfigRepository())->count() }} 项</div>
                        <div class="fw-bold text-gray-400">系统配置</div>
                    </div>
                </a>
            </div>
        @endif
        @if(acb_has_permission('abnermouke.console.admins.index', 'get'))
            <div class="col-xl-3">
                <a href="{{ route('abnermouke.console.admins.index') }}" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                    <div class="card-body">
                        ...
                        <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">{{ (new \App\Repository\Abnermouke\Console\AdminRepository())->count() }} 人</div>
                        <div class="fw-bold text-gray-100">管理员人数</div>
                    </div>
                </a>
            </div>
        @endif
        @if(acb_has_permission('abnermouke.console.admins.logs.index', 'get'))
            <div class="col-xl-3">
                <a href="{{ route('abnermouke.console.admins.logs.index') }}" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                    <div class="card-body">
                        ...
                        <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{ (new \App\Repository\Abnermouke\Console\AdminLogRepository())->count() }} 次</div>
                        <div class="fw-bold text-white">操作次数</div>
                    </div>
                </a>
            </div>
        @endif
        @if(acb_has_permission('abnermouke.console.help.docs.index', 'get'))
            <div class="col-xl-3">
                <a href="{{ route('abnermouke.console.help.docs.index') }}" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                    <div class="card-body">
                        <span class="svg-icon svg-icon-white svg-icon-3x ms-n1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{ (new \App\Repository\Abnermouke\Console\HelpDocRepository())->count() }} 篇</div>
                        <div class="fw-bold text-white">帮助文档</div>
                    </div>
                </a>
            </div>
        @endif

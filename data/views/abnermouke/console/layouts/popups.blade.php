{{--修改密码弹窗：Start--}}
<div class="modal fade" id="kt-edit_admin_password_modal" data-query-url="{{ route('abnermouke.console.admins.change.password') }}" tabindex="-1" aria-hidden="true">
                ...
                <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6">
                    ...
                    <div class="d-flex flex-stack flex-grow-1">
                        <div class="fw-bold">
                            ...
                            <div class="fs-6 text-gray-700">管理员密码修改成功后将在下次登录时生效，如需立即验证可点击 <a href="{{ route('abnermouke.console.oauth.sign.out') }}">前往登录页面</a></div>
                        </div>
                    </div>
                </div>
                <div class="row mb-5">

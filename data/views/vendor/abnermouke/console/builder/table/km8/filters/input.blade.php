<div class="col-lg-{{ $col_number }} acbt_filter_item" data-type="{{ $type }}" data-field="{{ $field }}" data-target="#acbt_filter_of_{{ $field }}">
    ...
    <input type="text" class="form-control form-control form-control-solid" name="{{ $field }}" placeholder="{{ data_get($extras, 'placeholder', $guard_name) }}" id="acbt_filter_of_{{ $field }}" value="{{ $default_value }}" />
</div>
